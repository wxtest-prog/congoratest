  ...
  return (
    ...
    />
            ...
            <div className="text-sm text-gray-600">
              &copy; Congora Incorporated - All rights reserved.
            </div>
          </div>
